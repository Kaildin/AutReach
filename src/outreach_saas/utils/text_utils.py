...
def clean_extracted_text(text):
    ...
    # Manteniamo lettere, numeri, parentesi e + (per telefoni)
    cleaned = re.sub(r'^[\s,.:;-]+', '', cleaned)
    
    # Rimuovi icone Google Maps ( per indirizzo,  per telefono)
...
def is_same_domain(url: str, candidate: str) -> bool:
    ...
    try:
        ...
        # Confronta netloc principal (senza www e senza porte)
